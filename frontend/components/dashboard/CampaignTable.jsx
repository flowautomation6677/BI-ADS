    ...
    const columns = useMemo(() => [
        ...
        columnHelper.accessor(row => row.metricas.cpm, {
            ...
            cell: info => {
                ...
                if (val > 40 && val <= 80) bgColor = 'bg-orange-50 text-orange-700 font-medium';
                if (val > 80) bgColor = 'bg-red-50 text-red-700 font-medium';
        ...
        columnHelper.accessor(row => row.metricas.ctr, {
            ...
            cell: info => {
                ...
                let bgColor = 'text-gray-700';
                if (val < 1) bgColor = 'bg-red-50 text-red-700 font-bold';
                else if (val >= 2) bgColor = 'bg-green-50 text-green-700 font-bold';
        ...
        columnHelper.accessor(row => row.metricas.roas, {
            id: 'roas',
            header: 'ROAS',
            cell: info => {
                const val = info.getValue() || 0;
                ...
                let bgColor = 'bg-blue-50 text-blue-700 font-medium'; // Default (1 - 2)
                if (val >= 2) bgColor = 'bg-green-50 text-green-700 font-bold'; // Excellent
                else if (val < 1) bgColor = 'bg-red-50 text-red-700 font-bold'; // Bad
